...
const Form = () => {
  ...
  const countries = ['India', 'USA', 'UK', 'Australia', 'Nepal'];
  const cities = {
    India: ['Delhi', 'Mumbai', 'Bangalore', 'Asansol', 'Kolkata'],
    USA: ['New York', 'Los Angeles', 'Chicago'],
    UK: ['London', 'Manchester', 'Liverpool'],
    Australia: ['Sydney', 'Melbourne', 'Darwin'],
    Nepal: ['Bharatpur', 'Kathmandu', 'Pokhara']
  };
